        ...
        if (didSpawn == false) {
            for (var s = 0, length = sources.length; s < length; s++) {
                ...
                for (var storeCreep = 0, length2 = scouts.length; storeCreep < length2; storeCreep++) {
                    if (stores[storeCreep] && stores[storeCreep].ticksToLive > 50 && creep.memory.sourceId && creep.memory.sourceId == sources[s]) {
                        mustCreate = false;
                        break;
                    }
                }
                if (mustCreate) {
                    //var newName5 = Game.spawns['Spawn1'].createCreep([MOVE, MOVE, CLAIM], undefined, { role: 'scout', sourceRoom: Memory.spots[scout].sourceRoom });
                    var newName5 = Game.spawns['Spawn1'].createCreep([WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE], undefined, { role: 'store', sourceId: sources[s] });
                    didSpawn = true;
                }
            }
        }
            ...
            if (didSpawn == false) {
                ...
                if (harvesters2.length < h2) {
                    var newName = Game.spawns['Spawn1'].createCreep([CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE], undefined, { role: 'harvester2' });
                }
                    ...
                    var newName = Game.spawns['Spawn1'].createCreep([CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, WORK, MOVE, WORK, MOVE, CARRY, CARRY, MOVE], undefined, { role: 'builder2' });
                }
                ...
                else if (upgraders2.length < u2) {
                    var newName = Game.spawns['Spawn1'].createCreep([CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE, CARRY, CARRY, MOVE], undefined, { role: 'upgrader2' });
                }
