...
module.exports.loop = function () {
    ...
    roleLogging.run(h, b, u, atk, harvesters, builders, upgraders, attackers, scouts, links);
    roleSpawn.run(h, b, u, atk, harvesters, builders, upgraders, attackers, scouts, links);
    roleTower.run();
