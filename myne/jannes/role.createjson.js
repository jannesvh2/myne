...
var roleCreateJSON = {
    ...
    run: function () {
        ...
        if (Memory.global.isNew) {
            ...
            Memory.spawns[1].links.producers.push('5818d44598bdae001bc6118d');
            ...
            Memory.spawns[2].links.producers.push('58189015736ce25e35e030a9');
            ...
            //RoomList
            Memory.spawns[3].random.rooms.push({ name: 'W7S53', spawn: 2 });
