...
var roleCreateJSON = {
    ...
    run: function () {
        ...
        if (Memory.global.isNew) {
            ...
            //Memory.spawns[3].links.producers.push({ id: '581e2c2cff5ef5bb166df9cf', source: false });
            ...
            if (!Memory.spawns[7].random.hostiles) {
                Memory.spawns[7].random.rooms.push({ name: 'W6S52', spawn: 3 });
