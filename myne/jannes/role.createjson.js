...
var roleCreateJSON = {
    ...
    run: function () {
        ...
        if (Memory.global.isNew) {
            ...
            Memory.spawns[6].reactions.push(new Array());
            Memory.spawns[6].reactions[0].push({ m: 'G', l: '583c22360d802d93244a3dc2' });
            ...
            Memory.spawns[6].reactions[1].push({ m: 'U', l: '58299cac6ff35bc4431fbe8a' });
            Memory.spawns[6].reactions[1].push({ m: 'L', l: '5829f9ced920fd6828a96f4b', r: 'W3S55' });
