...
var roleCreateJSON = {
    ...
    run: function () {
        ...
        if (Memory.global.isNew) {
            ...
            //Memory.spawns[3].random.nuker = '583812703c39d0fc0b2fdae7';
            ...
            Memory.spawns[4].random.overflow = 'W3S55';
            ...
            Memory.spawns[6].reactions[0].push({ m: 'G', l: '5829482e90cd896460ed38da' });
            ...
            Memory.spawns[6].reactions[2].push({ m: 'U', l: '58299cac6ff35bc4431fbe8a' });
            Memory.spawns[6].reactions[2].push({ m: 'L', l: '5829f9ced920fd6828a96f4b', r: 'W3S55' });
            ...
            if (!Memory.spawns[7].random.hostiles) {
                ...
                Memory.spawns[7].random.rooms.push({ name: 'W5S55', spawn: 8, sk: true });
            }
            //keeper
            if (!Memory.spawns[7].random.hostiles) {
